...
text text text text text text text text text text text text text
text text text text text text text text text text text text text
text text text text. text optional.
...
\begin{tabular}{rll}
   URL   & Uniform Resource Locator \\
         & \EnToBr{Localizador Uniforme de Recursos} \\
   ...
   SMART & Specific, Measurable, Achievable, Relevant, and Time-Bound \\
         & \EnToBr{Específico, Mensurável, Atingível, Relevante, e com
           Tempo Limitado} \\
\end{tabular}
...
\input{chapters/02-machine-learning-engineering}
\input{chapters/03-measuring-complexity}
\input{chapters/04-research-methodology}
\input{chapters/05-work-plan}
% \input{chapters/X-the-spira-project}
