...
\title{
    ...
    titlept={Um Modelo Arquitetural Baseado em Métricas para Caracterizar
Complexidade em Sistemas Inteligentes},
    titleen={A Metrics-Based Architectural Model to Characterize Complexity
...
\epigrafe{If you can not measure it, you can not improve it.}{Lord Kelvin}
\end{dedicatoria}
...
\begin{tabular}{rll}
   URL & Uniform Resource Locator (\emph{Localizador Uniforme de Recursos})      \\
   IME & Institute of Mathematics and Statistics (\emph{Instituto de Matemática e Estatística}) \\
   USP & University of São Paulo (\emph{Universidade de São Paulo})
\end{tabular}
...
\input{chapters/04-research-plan}
